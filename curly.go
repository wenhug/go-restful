...
var (
	...
	regexCacheEnabled = false // Enable/disable regex caching
)

// SetRegexCacheEnabled enables or disables regex pattern caching for CurlyRouter.
// When disabled (default), regex patterns will be compiled on every request.
// When enabled, compiled regex patterns are cached for better performance.
